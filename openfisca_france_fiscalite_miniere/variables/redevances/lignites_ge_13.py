...
class quantite_lignites_ge_13_kt(Variable):
    ...
    label = "Quantité extraite de lignites d'un pouvoir calorifique égal ou supérieur à 13 MJ/kg (par millier de tonnes nettes livrées)"
...
class redevance_communale_des_mines_fer(Variable):
    ...
    entity = Article
    definition_period = YEAR
    label = "Redevance communale des mines pour les lignites d'un pouvoir calorifique égal ou supérieur à 13 MJ/kg"
    reference = [
...
class redevance_departementale_des_mines_fer(Variable):
    value_type = float
    entity = Article
    label = "Redevance départementale des mines pour les lignites d'un pouvoir calorifique égal ou supérieur à 13 MJ/kg"
    definition_period = YEAR
    reference = [
