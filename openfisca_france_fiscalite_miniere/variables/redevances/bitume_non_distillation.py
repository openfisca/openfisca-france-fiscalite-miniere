...
class redevance_communale_des_mines_bitume_non_distillation(Variable):
    ...
    entity = Article
    definition_period = YEAR
    label = "Redevance communale des mines pour calcaires et grès bitumineux ou asphaltiques non destinés à la distillation"
    reference = [
...
class redevance_departementale_des_mines_bitume_non_distillation(Variable):
    value_type = float
    entity = Article
    label = "Redevance départementale des mines pour calcaires et grès bitumineux ou asphaltiques non destinés à la distillation"
    definition_period = YEAR
    reference = [
    ...
    def formula_2020_01(articles, period, parameters) -> ndarray:
        ...
        tarif_rdm = parameters(period).redevances.departementales.bitume_non_distillation
