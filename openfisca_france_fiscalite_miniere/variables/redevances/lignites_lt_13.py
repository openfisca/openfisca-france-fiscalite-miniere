...
class quantite_lignites_lt_13_kt(Variable):
    value_type = float
    entity = Article
    definition_period = YEAR
    label = "Quantité extraite de lignites d'un pouvoir calorifique inférieur à 13 MJ/kg (par millier de tonnes nettes livrées)"
...
class redevance_communale_des_mines_fer(Variable):
    ...
    entity = Article
    definition_period = YEAR
    label = "Redevance communale des mines pour les lignites d'un pouvoir calorifique inférieur à 13 MJ/kg"
    reference = [
    ...
    def formula_2020_01(articles, period, parameters) -> ndarray:
        ...
        quantite = articles("quantite_lignites_lt_13_kt", annee_production)
        
        tarif_rcm = parameters(period).redevances.communales.lignites_lt_13
...
class redevance_departementale_des_mines_fer(Variable):
    value_type = float
    entity = Article
    label = "Redevance départementale des mines pour les lignites d'un pouvoir calorifique inférieur à 13 MJ/kg"
    definition_period = YEAR
    reference = [
    ...
    def formula_2020_01(articles, period, parameters) -> ndarray:
        ...
        tarif_rdm = parameters(period).redevances.departementales.lignites_lt_13
