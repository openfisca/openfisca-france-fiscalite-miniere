...
class quantite_soufre_t(Variable):
    ...
    label = "Quantité extraite de minerai de soufre autres que les pyrites de fer (par tonne de soufre contenu)"
...
class redevance_communale_des_mines_soufre(Variable):
    ...
    entity = Article
    definition_period = YEAR
    label = "Redevance communale des mines pour le minerai de soufre autres que les pyrites de fer"
    reference = [
...
class redevance_departementale_des_mines_soufre(Variable):
    value_type = float
    entity = Article
    label = "Redevance départementale des mines pour le minerai de soufre autres que les pyrites de fer"
    definition_period = YEAR
    reference = [
