...
class quantite_lignites_ge_13_kt(Variable):
    value_type = float
    entity = Article
    definition_period = YEAR
    label = "Quantité extraite de lignites d'un pouvoir calorifique égal ou supérieur à 13 MJ/kg (par millier de tonnes nettes livrées)"  # noqa: E501
    reference = "https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000006294877/2020-03-25"  # noqa: E501


class redevance_communale_des_mines_lignites_ge_13(Variable):
    value_type = float
    entity = Article
    definition_period = YEAR
    label = "Redevance communale des mines pour les lignites d'un pouvoir calorifique égal ou supérieur à 13 MJ/kg"  # noqa: E501
    reference = [
    ...
    def formula_2020_01(articles, period, parameters) -> ndarray:
        ...
        quantite = articles("quantite_lignites_ge_13_kt", annee_production)

        tarif_rcm = parameters(period).redevances.communales.lignites_ge_13

        rcm = (quantite * tarif_rcm) * surface_communale_proportionnee
        return round(rcm, decimals = 2)


class redevance_departementale_des_mines_lignites_ge_13(Variable):
    value_type = float
    entity = Article
    label = "Redevance départementale des mines pour les lignites d'un pouvoir calorifique égal ou supérieur à 13 MJ/kg"  # noqa: E501
    definition_period = YEAR
    reference = [
    ...
    def formula_2020_01(articles, period, parameters) -> ndarray:
        ...
        tarif_rdm = parameters(period).redevances.departementales.lignites_ge_13
