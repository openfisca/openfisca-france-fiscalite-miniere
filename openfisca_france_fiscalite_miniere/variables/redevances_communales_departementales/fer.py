...
class quantite_fer_kt(Variable):
    value_type = float
    entity = Article
    definition_period = YEAR
    label = "Quantité extraite de minerai de fer (par millier de tonnes nettes livrées)"
...
class redevance_communale_des_mines_fer(Variable):
    ...
    entity = Article
    definition_period = YEAR
    label = "Redevance communale des mines pour le minerai de fer"
    reference = [
...
class redevance_departementale_des_mines_fer(Variable):
    value_type = float
    entity = Article
    label = "Redevance départementale des mines pour le minerai de fer"
    definition_period = YEAR
    reference = [
