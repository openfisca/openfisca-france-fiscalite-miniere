...
class quantite_lignites_lt_13_kt(Variable):
    ...
    label = "Quantité extraite de lignites d'un pouvoir calorifique inférieur à 13 MJ/kg (par millier de tonnes nettes livrées)"  # noqa: E501
...
class redevance_communale_des_mines_lignites_lt_13(Variable):
    ...
    entity = Article
    definition_period = YEAR
    label = "Redevance communale des mines pour les lignites d'un pouvoir calorifique inférieur à 13 MJ/kg"  # noqa: E501
    reference = [
